...
def process_log_file(cur, filepath):
    ...
    #conver timestamp column to datetime
    t = pd.Series(df['ts'], index=df.index)

    #insert time data records
    column_lables = ["timestamp", "hour", "day", "weelofyear", "month", "year", "weakday"]
    time_data = []
    for data in t:
...
def process_data(cur, conn, filepath, func):
    ...
    #interate over files and process
